<template>
  <v-layout>
    <v-app-bar
      color="#1e3a8a"
      class="elevation-12"
      style="user-select: none; position: fixed"
    >
      <router-link
        to="/"
        class="d-flex"
      ...
      >
        ...
        <v-app-bar-title style="width: 100%">
          <p class="text-overline mt-n1" style="margin-bottom: -9px">
            FRC Team 2641
          </p>
          <h5 style="margin-left: -1px" class="hidden-xs text-h5">
            Pittsburgh Central Catholic Robotics
          </h5>
          <h5 style="margin-left: -1px" class="hidden-sm-and-up text-h5">
            PCCR
          </h5>
        </v-app-bar-title>
      </router-link>
    ...
    <v-main>
      ...
      <v-footer
        :style="`display: ${mdAndUp ? 'flex' : 'block'}; padding-left: ${mdAndUp ? '15dvw' : '20px'}`"
        style="
          align-items: start;
          z-index: 0;
          position: relative;
      ...
      >
        <div class="mr-6">
          ...
          />
          <img
            class="hidden-md-and-up mt-n2 mb-n1"
            style="opacity: 0.9; margin-left: -16px"
            src="@/assets/seal.webp"
            height="175px"
          />
          <div
            class="d-flex mx-n2 mb-2"
            :style="`justify-content: ${mdAndUp ? 'center' : ''}`"
          >
            <v-btn
        ...
        <div>
          ...
          <h6 class="text-h6 mb-2" style="line-height: 28px">
            Pittsburgh Central&nbsp;<br class="hidden-md-and-up" />Catholic
            Robotics
          </h6>
          ...
          <p class="text-body-2">
            <a href="https://www.centralcatholichs.com" target="_blank"
              >www.centralcatholichs.com</a
            >
          </p>
          <p class="text-body-2 mb-3">
            <a href="tel:4122083400">(412) 208-3400</a>
          </p>
          <p class="text-body-2 mb-2 transparent-subtitle">
            &copy; {{ new Date().getFullYear() }} Pittsburgh Central Catholic
            Robotics
          </p>
          <p
            class="text-overline transparent-subtitle mt-n1 mb-n2"
            style="font-size: 9px !important"
          >
            Powered by
            <a href="https://www.frclookout.com" target="_blank">Lookout</a>.
            Design by
            <a href="https://www.aidanliddy.com" target="_blank">Aidan Liddy</a
            >.
          </p>
        </div>
