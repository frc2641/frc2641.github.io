<template>
	<v-row no-gutters>
		...
		<v-col cols="12" md="6" :style="lgAndUp ? 'padding: 90px' : 'padding: 24px'">
			...
			<v-text-field variant="solo" hide-details class="mb-4 mt-8" label="Name" v-model="data.name"></v-text-field>

			<v-row class="pa-0 mt-0">
				<v-col cols="12" sm="6">
					<v-text-field variant="solo" hide-details label="Phone" v-model="data.phone"></v-text-field>
				</v-col>

				<v-col cols="12" sm="6">
					<v-text-field variant="solo" hide-details class="mb-7" label="Email" v-model="data.email"></v-text-field>
				</v-col>
			</v-row>

			<v-text-field variant="solo" hide-details class="mb-7" label="Subject" v-model="data.subject"></v-text-field>

			<v-textarea variant="solo" hide-details label="Message" v-model="data.message"></v-textarea>
			...
			<section>
				<div class="d-flex mt-6">
					<v-btn href="mailto:cchsteam2641@gmail.com" icon="mdi-email" variant="text" color="grey"></v-btn>
